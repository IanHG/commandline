#ifndef COMMANDLINE_FROM_STRING_HPP_INCLUDED_
#define COMMANDLINE_FROM_STRING_HPP_INCLUDED_
...
template<>
std::string from_string(const std::string& str, size_t* pend)
{
   *pend = str.size();
   return str;
}
...
#endif /* COMMANDLINE_FROM_STRING_HPP_INCLUDED_ */
